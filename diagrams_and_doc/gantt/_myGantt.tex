...
\def\mystartdate{2025-2-18}%starting date of the calendar
\def\myenddate{2025-3-23}%ending date of the calendar

\newcommand{\oli}{(Daszczynska, Oliwia)}
\newcommand{\sophie}{(Kaiser, Sophie)}
\newcommand{\ishak}{(Bouaziz, Ishak)}
\newcommand{\genadij}{(Vorontsov, Genadij)}
